...
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_BACKDROP_THUMBNAIL;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_BEER_ID;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_CATEGORY;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_CONTENT;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_DESCRIPTION;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_IMAGE_THUMBNAIL;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_NAME;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_ORIGIN;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_PRICE;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_PRODUCE;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_STYLE;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_UPDATED;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_VARIETAL;
import static com.example.jonat.beerhaus.data.BeerContract.BeerEntry.COLUMN_VOLUME;
                 ...
                 new Thread(new Runnable() {
                     ...
                     public void run() {
                         ...
                         if (response.isSuccessful()) {
                             ...
                             mAdapter = new BeerAdapter(getActivity(), R.layout.content_list, beers, mCallbacks);
